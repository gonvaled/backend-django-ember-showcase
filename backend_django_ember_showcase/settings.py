"""
Django settings for backend_django_ember_showcase project.
...
SECRET_KEY = '-n0vzm@jze!_+rsoe2er9#qm+1kb&eshf8s$oi_%huegx#-i4x'
...
ROOT_URLCONF = 'backend_django_ember_showcase.urls'
...
WSGI_APPLICATION = 'backend_django_ember_showcase.wsgi.application'


# Parse database configuration from $DATABASE_URL: https://github.com/kennethreitz/dj-database-url
